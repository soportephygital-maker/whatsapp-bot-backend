...
UI_VERSION = '2026.09.17-114'
_original_html = target._html


def _html():
    html = _original_html()
    for old in ('2026.09.04-105', '2026.09.04-106', '2026.09.04-107', '2026.09.04-108', '2026.09.17-109', '2026.09.17-110', '2026.09.17-111', '2026.09.17-112', '2026.09.17-113'):
