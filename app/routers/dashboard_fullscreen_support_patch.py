...
UI_VERSION = '2026.09.02-54'


def _html() -> str:
    html = base_html()
    for old in ('2026.09.02-53','2026.09.02-52','2026.09.02-51','2026.09.02-50','2026.09.02-49','2026.09.02-48','2026.09.02-47','2026.09.02-46'):
...
#decisionFlow:fullscreen{height:100vh!important;max-height:none!important}.support-person-email-grid{display:grid;grid-template-columns:minmax(150px,1fr) minmax(160px,1fr) minmax(220px,1.4fr) auto;gap:8px;align-items:center}.support-person-email-grid button{width:auto}.support-email-linked{font-size:11px;color:#79f0b3}
